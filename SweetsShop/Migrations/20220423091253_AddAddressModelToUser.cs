...
{
    public partial class AddAddressModelToUser : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Housing = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    Entrance = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    Flat = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Users_AddressModels_AddressId",
                table: "Users",
                column: "AddressId",
